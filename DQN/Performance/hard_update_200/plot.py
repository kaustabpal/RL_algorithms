...
orange = "#fe8112"
plot_title = "DQN-CartPole. Hard Update. Update interval = 200"
beta = 0.88
TAU0_ = "0001"
MINI_BATCH_SIZE = [32, 64, 128, 256]
MINI_BATCH_COL = ['#f700ff', '#0000ff', '#00ff44', '#ffa600']
col_names = ['Episode', 'mean_score', 'std_dev']
save_plot = "hard_update_200.png"
for i in range(len(MINI_BATCH_SIZE)):
    read_performance="hard_update_200_minibatch_"+str(MINI_BATCH_SIZE[i])+".csv"
...
#############################################################################
plt.vlines([200,400,600,800],0,500,color ='k', linestyles = 'dotted')
